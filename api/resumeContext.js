...
ROLE: Senior Full-Stack Developer (Java, Spring Boot, React, Cloud Integrations)
LOCATION: Chennai, Tamil Nadu 600130, India
EMAIL: kodidhanush1402@gmail.com
PHONE: +91 9566365706
LINKEDIN: linkedin.com/in/dhanush-kodi1402
GITHUB: github.com/Dhanushkodi143

PROFESSIONAL SUMMARY:
Senior Full-Stack Developer with 4+ years of experience designing and delivering scalable enterprise applications in the Banking and FinTech domain. Proficient in Java, Spring Boot, React, and cloud-native integration technologies including AWS S3, Azure Event Hub, Apache Kafka, and ActiveMQ. Experienced in building end-to-end transport-layer integrations, mentoring development teams, and driving UI architecture using Nx Monorepo. Strong background in Agile methodologies, reusable component design, CI/CD pipelines, and workflow-driven banking platforms. Growing expertise in applied AI, including generative AI integration, Retrieval-Augmented Generation (RAG), and the Model Context Protocol (MCP).

TECHNICAL SKILLS:
- Backend: Java, Core Java, Spring Boot, Node.js, REST API Development, Microservices
- Frontend: React.js, Bootstrap, HTML5, CSS3, JavaScript (ES6+), TypeScript
- Databases: SQL, MySQL, PL/SQL, Query Optimization, Database Design
- Messaging & Streaming: Apache Kafka, ActiveMQ, RabbitMQ, Azure Event Hub, Azure Service Bus, IBM MQ
- Cloud & File Transfer: AWS S3, Azure Cloud, SFTP, FTP, SMTP
- CI/CD & DevOps: Jenkins, GitHub Actions, GitLab CI/CD, Docker, Maven
- Architecture & Tools: Nx Monorepo Architecture, Git (GitHub & GitLab), Agile/Scrum
- AI & Emerging Tech: Generative AI, Model Context Protocol (MCP), Retrieval-Augmented Generation (RAG), AI-assisted development tools
- Domain Knowledge: Banking Platforms, FinTech, Enterprise Integrations, Role-Based Access Control (RBAC)

PROFESSIONAL EXPERIENCE:

1. Consultant – Product Engineer, Intellect Design Arena | Chennai, India (Jun 2025 – Present)
...
2. Associate Consultant – Product Engineer, Intellect Design Arena | Chennai, India (Jun 2024 – Jun 2025)
...
3. Associate Software Developer, Techriffs Info Systems | Chennai, India (Jan 2022 – Jun 2024)
...
Velalar College of Engineering (Anna University) | Erode, India | May 2022
